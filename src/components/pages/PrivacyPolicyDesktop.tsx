...
const imgMaterialSymbolsLightCheck2 = '/img/material-symbols-light_check.svg';
const imgGrid = '/img/Grid.svg';
const imgFileText = '/img/file-text.svg';
const imgShieldCheck = '/img/shield-check.svg';
const imgCheck = '/img/material-symbols_check.svg';
