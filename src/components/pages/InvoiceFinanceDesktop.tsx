...
const imgTablerArrowDown = "https://www.figma.com/api/mcp/asset/a0604839-e405-4f35-8ef9-e77f99ce1619";
const imgGrid = "https://www.figma.com/api/mcp/asset/714b9faf-c82e-4a1e-bb88-b1aba7d9ce5d";
  ...
  return (
    <div className="bg-[#faf9f6] content-stretch flex flex-col items-start relative size-full" data-node-id="165:453" data-name="Invoice Finance - Desktop">
      ...
      <div className="bg-[#faf9f6] content-stretch flex flex-col items-start overflow-clip md:px-[80px] px-[20px] py-[96px] relative shrink-0 w-full" data-node-id="165:467" data-name="Hero">
        <div className="content-stretch flex gap-[113px] items-center overflow-clip relative shrink-0 w-full" data-node-id="165:468" data-name="Hero grid">
          <div className="content-stretch flex flex-col gap-[22px] items-start overflow-clip relative shrink-0 w-[520px]" data-node-id="165:469" data-name="left">
            ...
            <p className="[word-break:break-word] font-['Plus_Jakarta_Sans:ExtraBold'] font-extrabold leading-[1.08] min-w-full relative shrink-0 text-[#062530] text-[52px] w-[min-content]" data-node-id="165:471">
            ...
            <div className="bg-[#046675] content-stretch flex gap-[8px] h-[48px] items-center overflow-clip px-[26px] py-[24px] relative rounded-[100px] shrink-0 w-full md:w-auto" data-node-id="187:5" data-name="apply-btn">
          ...
          <div className="bg-[#062530] content-stretch flex flex-col h-[381px] items-start justify-end overflow-clip relative rounded-[28px] shadow-[0px_12px_32px_0px_rgba(20,23,28,0.14)] shrink-0 w-[500px]" data-node-id="165:475" data-name="Invoice Finance illustration">
            <div className="absolute h-[460px] left-0 top-0 w-[500px]" data-node-id="188:4" data-name="grid">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGrid} />
            </div>
            <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col h-[302px] items-start justify-center left-1/2 top-[calc(50%-10px)] w-[420px]" data-node-id="188:51" data-name="illustration">
              <div className="absolute left-[-40px] opacity-18 rounded-[130px] size-[260px] top-[-40px]" data-node-id="188:52" style={{ backgroundImage: "linear-gradient(135deg, rgb(4, 102, 117) 25%, rgb(7, 191, 219) 75%)" }} data-name="bg-arc" />
              <div className="absolute bottom-[-40px] opacity-12 right-[-40px] rounded-[130px] size-[260px]" data-node-id="188:53" style={{ backgroundImage: "linear-gradient(135deg, rgb(4, 102, 117) 25%, rgb(7, 191, 219) 75%)" }} data-name="bg-arc-2" />
              <div className="absolute content-stretch flex flex-col h-[115px] items-start left-0 opacity-84 top-[110px] w-[140px]" data-node-id="188:54" data-name="invoice-stack">
                <div className="bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_8px_9px_rgba(20,23,28,0.08)] flex flex-col gap-[6px] h-[70px] items-start mb-[-44px] p-[12px] relative rounded-[14px] shrink-0 w-full" data-node-id="188:55" data-name="invoice-1">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="188:56" data-name="Frame">
                    <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[12px] whitespace-nowrap" data-node-id="188:57">
                      INV-2048
                    </p>
                    <div className="relative shrink-0 size-[16px]" data-node-id="188:101" data-name="file-text">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgFileText} />
                    </div>
                  </div>
                  <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[normal] not-italic relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:59">
                    ₦1,250,000
                  </p>
                </div>
                <div className="bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_8px_9px_rgba(20,23,28,0.08)] flex flex-col gap-[6px] h-[70px] items-start mb-[-44px] p-[12px] relative rounded-[14px] shrink-0 w-full" data-node-id="188:60" data-name="invoice-2">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="188:61" data-name="Frame">
                    <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[12px] whitespace-nowrap" data-node-id="188:62">
                      INV-2049
                    </p>
                    <div className="relative shrink-0 size-[16px]" data-node-id="188:104" data-name="file-text">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgFileText} />
                    </div>
                  </div>
                  <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[normal] not-italic relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:64">
                    ₦980,000
                  </p>
                </div>
                <div className="bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_8px_9px_rgba(20,23,28,0.08)] flex flex-col gap-[6px] h-[59px] items-start p-[12px] relative rounded-[14px] shrink-0 w-full" data-node-id="188:65" data-name="invoice-3">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="188:66" data-name="Frame">
                    <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[12px] whitespace-nowrap" data-node-id="188:67">
                      INV-2050
                    </p>
                    <div className="relative shrink-0 size-[16px]" data-node-id="188:107" data-name="file-text">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgFileText} />
                    </div>
                  </div>
                  <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[normal] not-italic relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:69">
                    ₦2,100,000
                  </p>
                </div>
              </div>
              <div className="absolute content-stretch flex flex-col items-start left-[220px] size-[180px] top-[120px]" data-node-id="188:70" data-name="money-flow">
                <div className="bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_10px_11px_rgba(20,23,28,0.08)] flex flex-col gap-[6px] h-[60px] items-start p-[12px] relative rounded-[16px] shrink-0 w-[140px]" data-node-id="188:71" data-name="bank-card">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="188:72" data-name="Frame">
                    <div className="content-stretch flex items-center overflow-clip relative shrink-0 w-[95px]" data-node-id="187:4">
                      <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[12px] w-[105px]" data-node-id="188:73">
                        Business account
                      </p>
                    </div>
                    <div className="relative shrink-0 size-[16px]" data-node-id="188:110" data-name="credit-card">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgCreditCard} />
                    </div>
                  </div>
                  <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[normal] not-italic relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:75">
                    ₦3,330,000
                  </p>
                </div>
                <div className="absolute bg-[#e5eff1] content-stretch flex flex-col items-center justify-center left-[-16px] rounded-[30px] size-[60px] top-[45px]" data-node-id="188:76" data-name="arrow">
                  <div className="relative shrink-0 size-[22px]" data-node-id="188:113" data-name="arrow-right">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgArrowRight} />
                  </div>
                </div>
                <div className="absolute bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_10px_11px_rgba(20,23,28,0.08)] flex flex-col gap-[6px] h-[59px] items-start left-[90px] p-[12px] rounded-[12px] top-[100px] w-[140px]" data-node-id="188:80" data-name="advance">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="188:81" data-name="Frame">
                    <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[12px] whitespace-nowrap" data-node-id="188:82">
                      Advance
                    </p>
                    <div className="relative shrink-0 size-[16px]" data-node-id="188:119" data-name="zap">
                      <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgZap} />
                    </div>
                  </div>
                  <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[normal] not-italic relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:84">
                    Up to 80%
                  </p>
                </div>
                <div className="absolute bg-[#e5eff1] content-stretch flex flex-col items-center justify-center left-[110px] rounded-[30px] size-[60px] top-[-19px]" data-node-id="188:78" data-name="processing">
                  <div className="relative shrink-0 size-[22px]" data-node-id="188:116" data-name="refresh-cw">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgRefreshCw} />
                  </div>
                </div>
              </div>
              <div className="absolute bg-white border border-[#e7e5e1] border-solid content-stretch drop-shadow-[0px_10px_11px_rgba(20,23,28,0.08)] flex gap-[10px] h-[60px] items-center left-[40px] px-[14px] py-[10px] rounded-[16px] top-[40px] w-[180px]" data-node-id="188:85" data-name="payment-processing">
                <div className="bg-[#e5eff1] content-stretch flex flex-col items-center justify-center relative rounded-[18px] shrink-0 size-[36px]" data-node-id="188:86" data-name="Frame">
                  <div className="relative shrink-0 size-[18px]" data-node-id="188:122" data-name="shield-check">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgShieldCheck} />
                  </div>
                </div>
                <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start leading-[normal] min-w-px not-italic relative" data-node-id="188:88" data-name="Frame">
                  <p className="font-['Inter:Bold'] font-bold min-w-full relative shrink-0 text-[#062530] text-[12px] w-[min-content]" data-node-id="188:89">
                    Payment processing
                  </p>
                  <p className="font-['Inter:Regular'] font-normal relative shrink-0 text-[#55606b] text-[11px] whitespace-nowrap" data-node-id="188:90">
                    Verified receivables
                  </p>
                </div>
              </div>
              <div className="[word-break:break-word] absolute bg-white content-stretch flex flex-col gap-[6px] items-start leading-[normal] left-0 overflow-clip px-[18px] py-[16px] rounded-[18px] shadow-[0px_12px_32px_0px_rgba(20,23,28,0.14)] top-[2px] w-[196px] whitespace-nowrap" data-node-id="188:91" data-name="Float card A">
                <p className="font-['Inter:Semi_Bold'] font-semibold not-italic relative shrink-0 text-[#8b939c] text-[10.5px] tracking-[0.21px]" data-node-id="188:92">
                  AVAILABLE GROWTH FACILITY
                </p>
                <p className="font-['Plus_Jakarta_Sans:ExtraBold'] font-extrabold relative shrink-0 text-[#062530] text-[21px]" data-node-id="188:93">
                  ₦5,000,000
                </p>
              </div>
              <div className="absolute bg-white content-stretch flex gap-[10px] h-[76px] items-center left-0 overflow-clip pl-[16px] pr-[18px] py-[14px] rounded-[16px] shadow-[0px_12px_32px_0px_rgba(20,23,28,0.14)] top-[245px]" data-node-id="188:94" data-name="Float card B">
                <div className="relative shrink-0 size-[24px]" data-node-id="188:95" data-name="material-symbols:check">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgMaterialSymbolsCheck} />
                </div>
                <div className="[word-break:break-word] content-stretch flex flex-col gap-[2px] items-start leading-[normal] not-italic overflow-clip relative shrink-0 whitespace-nowrap" data-node-id="188:97" data-name="cardB text">
                  <p className="font-['Inter:Semi_Bold'] font-semibold relative shrink-0 text-[#062530] text-[13px]" data-node-id="188:98">
                    Application received
                  </p>
                  <p className="font-['Inter:Regular'] font-normal relative shrink-0 text-[#55606b] text-[11.5px]" data-node-id="188:99">{`We'll keep you updated`}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-[#faf9f6] content-stretch flex flex-col gap-[32px] items-start overflow-clip pb-[60px] md:px-[80px] px-[20px] relative shrink-0 w-full" data-node-id="165:490" data-name="Body">
        <div className="content-stretch flex gap-[56px] items-start overflow-clip relative shrink-0 w-full" data-node-id="165:491" data-name="body grid">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px overflow-clip relative" data-node-id="165:492" data-name="body left">
            ...
            <p className="[word-break:break-word] font-['Inter:Regular'] font-normal leading-[1.55] not-italic relative shrink-0 text-[#55606b] text-[14px] w-[560px]" data-node-id="165:494">
          ...
          <div className="[word-break:break-word] bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic overflow-clip p-[24px] relative rounded-[16px] shrink-0 w-[360px] whitespace-nowrap" data-node-id="165:495" data-name="docs">
      ...
      <div className="bg-[#faf9f6] content-stretch flex flex-col items-start overflow-clip pb-[80px] md:px-[80px] px-[20px] relative shrink-0 w-full" data-node-id="165:500" data-name="Related">
        ...
        <div className="content-stretch flex gap-[18px] items-start overflow-clip relative shrink-0 w-[1295px]" data-node-id="165:503" data-name="rel row">
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="165:504" data-name="rel-card">
          ...
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="165:506" data-name="rel-card">
          ...
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="165:508" data-name="rel-card">
          ...
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="196:2" data-name="rel-card">
            <p className="[word-break:break-word] font-['Inter:Bold'] font-bold leading-[normal] not-italic relative shrink-0 text-[#062530] text-[13.5px] whitespace-nowrap" data-node-id="196:3">
              Invoice Finance
            </p>
          </div>
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="224:1535" data-name="rel-card">
          ...
          <div className="bg-white border border-[#e7e5e1] border-solid content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px overflow-clip px-[18px] py-[20px] relative rounded-[14px]" data-node-id="224:1537" data-name="rel-card">
